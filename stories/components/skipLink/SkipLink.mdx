...
Optionally, these links can be added to enable users to skip over other repetitive 
content with many focusable elements like tables of contents.
...
Table of contents (includes a skip link example)
