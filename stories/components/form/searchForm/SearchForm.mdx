...
When the search includes additional controls, each control needs its own visible
label. Labels sit above the element they describe so that the input and any
controls stay aligned.

<Story of={stories.withVisibleLabelAndInlineControls} />
