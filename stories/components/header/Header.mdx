...
The header can include a simple text brand/site description, and comes in white or dark blue themes. 
Use the `header--white` and `header--blue` classes to specify color:
