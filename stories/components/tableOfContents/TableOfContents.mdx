...
containing the page's main content (shown in this example as `#documentation`). 
Use a color-specific class which contrasts with the table of contents background color:
